...
Gebruik een strikt valide OAS als invoer. Laat generatie stoppen wanneer de
specificatie niet door OpenAPI Generator wordt geaccepteerd.
...
en registreer je die in `implementation/index.ts`.
